...
class OpenAISettingsFragment : Fragment() {
    ...
    private fun setupToolbar() {
        // 设置返回按钮
        (requireActivity() as? MainActivity)?.setToolbarTitle("OpenAI 配置")
    ...
    private fun setupSaveButton() {
        binding.saveButton.setOnClickListener {
            ...
            // 暂时显示成功提示
            android.widget.Toast.makeText(requireContext(), "OpenAI配置已保存", android.widget.Toast.LENGTH_SHORT).show()
        }
    }
