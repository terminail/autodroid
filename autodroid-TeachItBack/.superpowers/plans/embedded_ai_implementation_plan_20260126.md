...
**实现内容**:
- ✅ 实现发送前输入建议检测
- ✅ 添加11种输入类型识别（简单问答、概念解释、复杂推理、答案评估、数学、创意写作、代码生成、文件处理、思维导图、长文本、通用）
- ✅ 集成到ChatFragment的发送按钮
- ✅ 显示建议对话框，用户可选择采纳或忽略
- ✅ 支持推荐服务偏好传递
...
**实现内容**:
- ✅ 集成InputSuggestionDetector到发送按钮
- ✅ 添加发送前检测和建议对话框
- ✅ 支持采纳建议或忽略建议两种选择
- ✅ 添加推荐服务偏好传递机制
- ✅ 优化消息发送流程，支持指定服务
...
**测试内容**:
- ✅ InputSuggestionDetector关键词检测功能
- ✅ ChatFragment建议对话框显示
- ✅ MessageRepository服务偏好路由
- ✅ AIServiceRouter优先服务选择
- ✅ ViewModel消息发送流程
