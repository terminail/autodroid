#!/usr/bin/env python3
"""
Autodroid Analyzer API Server
This script starts the API server only
"""
...
def print_startup_info(host, port):
    ...
    print("\n" + "="*60)
    print("🚀 Autodroid Analyzer API Server Started")
    print("="*60)
    ...
    print("="*60)
    print("Note: Frontend should be started separately with 'npm run dev'")
    print("Press Ctrl+C to stop the server")
    print("="*60 + "\n")

async def main():
    """Run the API server with proper async handling"""
    config = load_config()
    ...
    port = backend_config.get('port', 8000)  # Use 8000 as default for analyzer
