...
import com.autodroid.aas.database.UIRecorderDatabase


import com.autodroid.aas.ui.adapters.UIEventAdapter

import com.autodroid.aas.ui.viewmodels.UIEventViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    private fun isAccessibilityServiceEnabled(): Boolean {
        val service = "$packageName/${com.autodroid.aas.service.UIRecorderAccessibilityService::class.java.canonicalName}"
