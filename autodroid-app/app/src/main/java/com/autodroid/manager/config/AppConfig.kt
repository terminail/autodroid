package com.autodroid.manager.config
...
data class NetworkConfig(
    val mdns: MDNSConfig = MDNSConfig(),
    val wifi: WiFiConfig = WiFiConfig()
)

data class MDNSConfig(
    val enabled: Boolean = true,
    val serviceType: String = "_autodroid._tcp.local.",
    val discoveryTimeout: Int = 10
)
...
object ConfigManager {
    ...
    fun getConfig(): AppConfig {
        return config ?: throw IllegalStateException("Config not loaded. Call loadConfig() first.")
    }
